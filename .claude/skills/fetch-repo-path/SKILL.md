...
description: Looks up the local path of a named repository by reading the repos registry at /path/to/works/for/you/knowledge_base/context/registry/repos.md. Use this whenever you need a repo's path and don't already know it — do not guess or hardcode paths.
---
...
```
/path/to/works/for/you/knowledge_base/context/registry/repos.md
```

## How to Use

1. Read `/path/to/works/for/you/knowledge_base/context/registry/repos.md` using the Read tool.
